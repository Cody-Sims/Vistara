...
public partial class AddOidcLoginRequests : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                state_digest = table.Column<byte[]>(type: "BLOB", maxLength: 32, nullable: false),
                provider_id = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                nonce_digest = table.Column<byte[]>(type: "BLOB", maxLength: 32, nullable: false),
                handle_digest = table.Column<byte[]>(type: "BLOB", maxLength: 32, nullable: false),
                code_verifier = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                redirect_uri = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: false),
                return_to = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: false),
