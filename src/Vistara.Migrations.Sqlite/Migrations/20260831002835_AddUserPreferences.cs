    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                density = table.Column<string>(type: "TEXT", maxLength: 16, nullable: false),
                reduced_motion = table.Column<bool>(type: "INTEGER", nullable: false),
                screen_reader_paged_mode = table.Column<bool>(type: "INTEGER", nullable: false),
                locale = table.Column<string>(type: "TEXT", maxLength: 35, nullable: true),
