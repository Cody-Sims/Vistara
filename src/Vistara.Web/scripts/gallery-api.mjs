...
function validateVistaraMetadata(manifest) {
  if (
    ...
    manifest["x-vistara-contract-source"] !== "runtime-endpoint-catalog" ||
    manifest["x-vistara-runtime-gallery-routes"] !== true
  ) {
    throw new Error(
      "Gallery manifest must be the OpenAPI 3.1 runtime endpoint catalog.",
    );
  }
